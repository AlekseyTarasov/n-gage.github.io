...
<p style="color:#FF0000">Пока только для Symbian 6-8</p>. Для Symbian 9 если и будет, то позже.
НЕ требует Python.

<p style="color:#FF0000">Некоторые антивирусы могут определить как вирус</p>, однако программа абсолютно безвредна.
