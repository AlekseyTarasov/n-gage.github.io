...
<b>Пока только для Symbian 6-8.</b> Для Symbian 9 если и будет, то позже.
НЕ требует Python.

<b>Некоторые антивирусы могут определить как вирус,</b> однако программа абсолютно безвредна.
