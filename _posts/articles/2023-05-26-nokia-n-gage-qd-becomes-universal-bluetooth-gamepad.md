...
Якщо ви хочете використовувати N-Gage як геймпад тільки для Windows ПК, спробуйте нову програму [GamepadBT-Server](https://github.com/BeardoGuy/GamepadBT-Server/). Додаткове обладнання не потрібне.
...
{:.img-center}
![Digispark Wiring](/n-gage/articles/Digispark_Wiring_Diagram-001.jpg)
